...
caseHelloWorld =  
  ...
  @=? (show $ doParse functionDeclaration srcHelloWorld)
caseMinHelloWorld = 
...
caseHelloWorld2 =  
  ...
  @=? (show $ doParse functionDeclaration srcHelloWorld2)
caseMinHelloWorld2 =  
...
caseSimpleAssignment = 
  ...
  @=? (show $ doParse statementList srcSimpleAssignment)
...
caseEmptyFor =
  ...
  @=? (show $ doParse iterationStatement srcEmptyFor)
...
caseFullFor =
  ...
  @=? (show $ doParse iterationStatement srcFullFor)
...
caseForVarFull =
  ...
  @=? (show $ doParse iterationStatement srcForVarFull)
...
caseIfElse1 =
  ...
  @=? (show $ doParse program srcIfElse1)
caseMinIfElse1 =
...
caseIfElse2 =
  ...
  @=? (show $ doParse program srcIfElse2)
caseMinIfElse2 =
...
case01_semi1 =
  ...
  @=? (show $ doParse program src01_semi1)
caseMin01_semi1 =
...
case_min_100_animals =
  ...
  @=? (show $ doParse program src_min_100_animals)
...
caseNestedSquare =
  ...
  @=? (show $ doParse program srcNestedSquare)
caseMinNestedSquare =  
