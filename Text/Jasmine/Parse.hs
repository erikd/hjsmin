...
data JSValue = NoValue | JSValue String | JSIdentifier String
    deriving (Show, Eq, Read, Data, Typeable)
...
assignmentExpression = try (do {v1 <- leftHandSideExpression; v2 <- assignmentOperator; v3 <- assignmentExpression;
